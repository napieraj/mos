# GENERATED by scripts/gen-completions.py from the CLI command table (the &mos_cli_command_* array in cli/main.c, each cli/<verb>.c descriptor, cli/tray.c actions).
