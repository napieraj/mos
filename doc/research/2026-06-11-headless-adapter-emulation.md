...
the interposed time seam), `tests/test_adapter_probe0.c` (the §13
mechanism probe), `tests/test_adapter_phase2.c` (single-target
...
scenario was written — `tests/test_adapter_probe0.c`, run first in the
